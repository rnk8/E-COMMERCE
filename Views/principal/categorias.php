...
?>
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white btnAddCart" href="#" prod="<?php echo $producto['id']; ?>"><i class="fas  fa-heart"></i></a></li>
    ...
    <ul class="pagination pagination-lg justify-content-end">
        ...
        if ($data['pagina'] > 1){
            echo '<li class="page-item"><a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="tuarchivo.php?pagina='. $url . '/' . $anterior.'">Anterior</a></li>';
        }
        if ($data['total'] >= $siguiente ){
            echo '<li class="page-item"><a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-white" href="tuarchivo.php?pagina='. $url . '/' . $siguiente.'">Siguiente</a></li>';
        }
        ?>
    </ul>
</div>
